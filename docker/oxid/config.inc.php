...
$this->dbCharset = 'utf8';
$this->dbHost = \getenv('OXID_DB_HOST'); // database host name
$this->dbPort  = 3306; // tcp port to which the database is bound
$this->dbName = \getenv('OXID_DB_NAME'); // database name
$this->dbUser = \getenv('OXID_DB_USER'); // database user name
$this->dbPwd = \getenv('OXID_DB_PASS'); // database user password
$this->dbDriverOptions = []; // database driver options
$this->dbUnixSocket = null; // unix domain socket, optional
$this->sShopURL = \getenv('SHOP_URL_PLAIN'); // eShop base url, required
$this->sSSLShopURL = \getenv('SHOP_URL_SSL');
$this->sAdminSSLURL = \getenv('SHOP_URL_SSL').'/admin';
$this->sShopDir = '/var/www/source';
$this->sCompileDir = '/tmp';
