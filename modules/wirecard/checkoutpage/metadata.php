...
$aModule = array(
    ...
    'blocks' => array(
        ...
        array(
            ...
            'file' => '/application/views/blocks/wcp_thankyou.tpl'
        ),
        array(
            'template' => 'page/checkout/payment.tpl',
    ...
    'settings' => array(
        ...
        array(
            'group' => 'wcp_settings',
            'name' => 'bWcpSendAdditionalCustomerData',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_settings',
            'name' => 'bWcpSendAdditionalBasketData',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_settings',
            'name' => 'bWcpLogConfirmations',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_settings',
            'name' => 'sWcpCheckoutFolder',
            'type' => 'select',
        ...
        array(
            'group' => 'wcp_settings',
            'name' => 'bWcpDisableDeviceDetection',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
        ...
        array(
            ...
            'name' => 'bWcp_bancontact_mistercash_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_ccard_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_ccard-moto_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_masterpass_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_ekonto_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_epay_bg_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_eps_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_giropay_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_idl_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_installment_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_invoice_b2b_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_invoice_b2c_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_maestro_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_moneta_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_paypal_UseIframe',
            'type' => 'bool',
            'value' => '0'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_pbx_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_poli_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_przelewy24_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
        ...
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_sepa-dd_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_skrillwallet_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_sofortueberweisung_UseIframe',
            'type' => 'bool',
            'value' => '0'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_tatrapay_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_trustly_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_voucher_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),
        array(
            'group' => 'wcp_iframe_settings',
            'name' => 'bWcp_trustpay_UseIframe',
            'type' => 'bool',
            'value' => '1'
        ),

        array(
            'group' => 'wcp_installment_invoice_settings',
            'name' => 'sWcpInvoiceProvider',
            'type' => 'select',
            'value' => 'WIRECARD',
            'constraints' => 'PAYOLUTION|RATEPAY|WIRECARD'
        ),
        array(
            'group' => 'wcp_installment_invoice_settings',
            'name' => 'sWcpInstallmentProvider',
            'type' => 'select',
            'value' => 'PAYOLUTION',
        ...
        array(
            'group' => 'wcp_installment_invoice_settings',
            'name' => 'sWcpPayolutionMId',
            'type' => 'str',
            'value' => ''
        ),
        array(
            'group' => 'wcp_installment_invoice_settings',
            'name' => 'bWcpInstallmentTrustedShopsCheckbox',
            'type' => 'bool',
            'value' => ''
        ),
        array(
            'group' => 'wcp_installment_invoice_settings',
            'name' => 'bWcpInvoiceb2bTrustedShopsCheckbox',
            'type' => 'bool',
            'value' => ''
        ),
        array(
            'group' => 'wcp_installment_invoice_settings',
            'name' => 'bWcpInvoiceb2cTrustedShopsCheckbox',
            'type' => 'bool',
            'value' => ''
        ),
        array(
            'group' => 'wcp_installment_invoice_settings',
            'name' => 'bWcpPayolutionAllowDifferingAddresses',
            'type' => 'bool',
            'value' => ''
        ),
    ),
